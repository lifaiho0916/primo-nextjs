    ...
    <footer className="relative w-full bg-[#fafafa] border-t-[1px]  border-[#eaeaea] pt-20">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="flex">
          <div className="w-3/12">
            ...
            <div className="status_code pt-7 flex items-center ">
              ...
              <span className="w-2.5 h-2.5 bg-[#f5a623] rounded-3xl m-1 mt-0.5 mb-0.5"></span>
              <span className="text-[#f5a623] text-sm pt-0.5 pb-0.5">Intermittent GitHub Login Issu...</span>
            </div>
          </div>
        ...
        <div>
          <Typography
            variant="small"
            className="mb-4 text-left font-normal text-blue-gray-900 md:mb-0 text-[#666]"
          >
            &copy; {currentYear} Vercel Inc.
          </Typography>

          <div className=" flex w-full flex-col items-center justify-center   border-blue-gray-50 py-4 md:flex-row md:justify-between items-center">
