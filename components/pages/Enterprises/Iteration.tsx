    ...
    <div className="iteration_outer_section">
      <div className="workflow_section flex-col flex pt-4 gap-16">
        <div className="stack_header_headersection flex flex-col items-center gap-6 ">
          <span className="inline-flex items-center rounded-full bg-[#000] px-2 py-1 text-xs font-medium text-white ring-1 ring-inset ring-gray-500/10 darkbutton">
            Collaboration
          </span>
          <div className="text-[50px] font-bold tracking-[-.04em]  text-[#272727] workflow_heading lg:[50px] dark-white-color ">
            Faster iteration. More innovation.
          </div>
          <span className="w-82 text-[20px]   break-words text-center text-gray-700  font-normal font-['Space_Grotesk'] workflow_description">
            The platform for rapid progress. Let your team focus on shipping
            features instead of <br /> managing infrastructure with automated
        ...
        <img src="/assets/iteration_img.png" className="invertlogo"></img>
        </div>
          ...
          <div className="stack_stack_outer grid gap-6">
            <div className="workflow_cardsgrid grid gap-6 grid-cols-[repeat(2,calc(50%-24px)+24px /2)] grid-cols-2">
              <a className="workflow_workflowCardLinkWrapper no-underline text-black">
                <div className="workflow_workflow_workflowCard__B_JoN border border-[rgba(0,0,0,0.1)] rounded-[20px] p-6 grid gap-4 border_class">
                  ...
                  <div className="workflow_card_content flex flex-col gap-0">
                    <h3 className="text-2xl font-semibold leading-8 dark-white-color">
                      Make collaboration seamless
                    </h3>
                    <p className="leading-6 text-[#666] my-2.5">
                      Give your team and stakeholders the tools to share
                      feedback and iterate faster. Instantly deploy
                      collaborative staging environments with every update.
                    </p>
                  </div>
                  <div className="workflow_card_footer">
                    <div className="workflow_card_footerlink flex items-center">
                      <span className="font-normal text-gray-700 font-['Space_Grotesk']">
                        Previews
                      </span>
                      <RightArrow />
                    </div>
              ...
              <a className="workflow_workflowCardLinkWrapper no-underline text-black">
                <div className="workflow_workflow_workflowCard__B_JoN border border-[rgba(0,0,0,0.1)] rounded-[20px] p-6 grid gap-4">
                  <div className="workflow_workflow_card_details grid gap-8 ">
                    <div className="card_visual p-4 h-56 flex relative item-center justify-center">
                      <div className=" workflow_deployments py-4 px-8 border border-[#eaeaea] bg-[#fafafa] relative max-w-[500px] rounded-lg dark_dark_background_color dark_workflow_deployment">
                        <div className="workflow_visuallyHidden w-px h-px absolute overflow-hidden">
                          An image of 2 deployments on Vercel. One is labeled as
                          production on the main branch and it is deployed and
                          ready. The other is labeled as a preview deployment on
                          a feature branch and it is currently building.
                        </div>
                        <div className="stack_stack_workflow_deployment  py-4 relative border-b-1 border-[#eaeaea] ">
                          <div className="stack_stack__iZkUS stack flex gap-4 items-end ">
                            <div className="stack_stack__iZkUS stack workflow_deploymentNameType__qzET9 w-24 grid gap-1">
                              <p className="font-semibold text-[#222] antialiased">
                                m55uezf9h
                              </p>
                            ...
                            <div className="stack_stack__iZkUS stack workflow_deploymentStatus flex gap-[13px] w-24 items-center ">
                              ...
                              <p className="font-semibold text-[#222] antialiased">Ready</p>
                            </div>
                        ...
                        <div className="workflow_deployment__2uYVi py-4 flex justify-start ">
                          <div className="stack_stack__iZkUS stack flex gap-4 items-end">
                            ...
                            <div className="workflow_deploymentStatus__wbAU4 flex gap-2 w-24 ">
                              <div
                                className="stack_stack__iZkUS stack workflow_statusIndicator__nNDGi w-px"
                                data-version="v1"
                              >
                                <div
                                  className="spinner_wrapper__zbFtL gap-4"
                                  data-geist-spinner=""
                                  data-version="v1"
                                >
                  ...
                  <div className="workflow_card_content flex flex-col gap-0">
                    ...
                    <p className="leading-6 text-[#666] my-2.5">
                      With zero-configuration pre-production environments that
                      integrate with your git workflow and builds that happen in
                      minutes, Vercel removes the barriers that often slow teams
                      down.
                    </p>
                  </div>
                  <div className="workflow_card_footer">
              ...
              <a className="testimonial_link no-underline text-black">
                <div className="testimonial_testimonial_stack grid gap-8 p-8 border border-[rgba(0,0,0,0.1)] rounded-2xl relative ">
                  <q className="testimonial_quote font-medium text-2xl text-center break-normal">
                    All of our results pages were developed and deployed on
                    Vercel, and it was the smoothest election night anyone could
                    remember.
                  </q>
